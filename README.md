...
## Onlile-bank
Реализована возможность создавать и удалять заявки , обновлять статус, авторизоваться и переходить по страницам

Демо версия
<a href='https://veu-online-bank.web.app/auth'>https://veu-online-bank.web.app/auth </a>
<div align="left">
...
## Проект сожержит
<details>
  <summary >Progressive Web Applications (PWA) </summary>

  [Что это?](https://developer.mozilla.org/ru/docs/Web/Progressive_web_apps)
